...
<div class="container" style="padding-top: 50px; padding-bottom: 70px">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>Thank you for providing your details. Before you can reset your password we need you to go to your email and click the link in the email we just sent you.</p>
